      ...
      <div className="inputlogin p-4 flex flex-col mx-auto justify-center shadow-slate-700 shadow-lg shadow-gray-400 bg-white content-center items-center">
        ...
        <div className="flex flex-col gap-4 mb-4 justify-center items-center social-login-btns">
          <button
            ...
            className="flex justify-center items-center gap-2 w-[380px] text-base text-black border-2 border-gray-500 rounded-lg shadow-lg max-w-xs px-6 py-2 text-sm font-medium focus:outline-none focus:ring-0"
          >
            <svg
          ...
          >
            <svg
              className="h-[26px] w-[26px] rounded-full mr-2"
              xmlns="http://www.w3.org/2000/svg"
              xmlnsXlink="http://www.w3.org/1999/xlink"
              viewBox="0 0 73 73"
              version="1.1"
